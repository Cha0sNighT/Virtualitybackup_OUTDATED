local weashop = {
	...
	menu = {
		...
		["Melee"] = {
			...
			name = "Melee",
			buttons = {
				{title = "Knife", name = "Knife", costs = 1000, description = {}, model = "WEAPON_Knife"},
				...
				-- {title = "KnuckleDuster", name = "KnuckleDuster", costs = 120000, description = {}, model = "WEAPON_KnuckleDuster"},
				 ...
				 {title = "Flashlight", name = "Flashlight", costs = 500, description = {}, model = "WEAPON_Flashlight"},
		...
		["Pistolets"] = {
			...
			name = "Pistolets",
			buttons = {
				--{title = "Pistol", name = "Pistol", costs = 10000, description = {}, model = "WEAPON_Pistol"},
				--{title = "Combat Pistol", name = "CombatPistol", costs = 10000, description = {}, model = "WEAPON_CombatPistol"},
				--{title = "Pistol Cal 50", name = "Pistol50", costs = 25000, description = {}, model = "WEAPON_PISTOL50"},
				--{title = "SNS Pistol", name = "SNSPistol", costs = 25000, description = {}, model = "WEAPON_SNSPistol"},
				{title = "Heavy Pistol", name = "HeavyPistol", costs = 18000, description = {}, model = "WEAPON_HeavyPistol"},
				...
				{title = "AP Pistol", name = "APPistol", costs = 25000, description = {}, model = "WEAPON_APPistol"},
		 ...
		 ["ThrownWeapons"] = {
			 ...
			 buttons = {
				...
				-- {title = "Molotov", name = "Molotov", costs = 85000, description = {}, model = "WEAPON_Molotov"},
				 {title = "Fire Extinguisher", name = "FireExtinguisher", costs = 1000, description = {}, model = "WEAPON_FireExtinguisher"},
				 {title = "Petrol Can", name = "PetrolCan", costs = 500, description = {}, model = "WEAPON_PetrolCan"},
