...
--====================================================================================
  ...
  AddEventHandler('jail:teleportPlayer', function(amount)
  	if(isHandCuffed == true) then
  		...
  		TriggerEvent('chatMessage', 'SYSTEM', {255, 0, 0}, "Vous êtes condamné à "..amount.." secondes de prison fédérale")
  		...
  		Citizen.CreateThread(function()
  			...
  			TriggerEvent('chatMessage', 'SYSTEM', {255, 0, 0}, "Vos armes ont été confisquées.")

  			-- Arrest
  			TriggerEvent('police:getArrested', t)
  		end)
  	else
  		TriggerEvent('chatMessage', 'SYSTEM', {255, 0, 0}, "Le joueur n'est pas menotté.")
  	end
  end)
