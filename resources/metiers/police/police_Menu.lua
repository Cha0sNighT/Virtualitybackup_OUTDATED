...
itemMenuChoixPoliceVehicleCar = {
    ...
    ['Items'] = {
        ...
        {['Title'] = 'Cadet confirmé', ['Function'] = POLICE_SpanwVehicleCar, type = 'Car', model = 'police'},
        {['Title'] = 'Brigadier', ['Function'] = POLICE_SpanwVehicleCar,  type = 'Car', model = 'police2'},
        {['Title'] = 'Brigadier Chef', ['Function'] = POLICE_SpanwVehicleCar,  type = 'Car', model = 'police3'},
        ...
        {['Title'] = 'Banalisée', ['Function'] = POLICE_SpanwVehicleCar,  type = 'Car', model = 'police4'},
        {['Title'] = 'Tout Terrain', ['Function'] = POLICE_SpanwVehicleCar,  type = 'Car', model = 'sheriff2'},
