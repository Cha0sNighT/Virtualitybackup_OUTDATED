...
local lsc = {
	...
	,["primarymetallic"] = {
		...
		["windows"] = {
			...
			buttons = {
				...
				{name = "Pure Black",tint = 1, costs = 10000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Darksmoke",tint = 2, costs = 8000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Lightsmoke",tint = 3, costs = 4000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Limo",tint = 4, costs = 2000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Green",tint = 5, costs = 2000, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["wheelaccessories"] = {
		...
		["secondaryclassic"] = {
			...
			buttons = {
				...
				{name = "Lowered Suspension",mod = false,modtype =15, costs = 2000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Street Suspension",mod = 1,modtype =15, costs = 4000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Sport Suspension",mod = 2,modtype =15, costs = 6000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Competition Suspension",mod = 3,modtype =15, costs = 8000, description = "", centre = 0, font = 0, scale = 0.4}
			}
		},
		["transmission"] = {
			title = "transmissions",
			...
			buttons = {
				...
				{name = "Street Transmission",mod = false,modtype =13, costs = 2000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Sports Transmission",mod = 1,modtype =13, costs = 4000, description = "", centre = 0, font = 0, scale = 0.4},
				{name = "Race Transmission",mod = 2,modtype =13, costs = 6000, description = "", centre = 0, font = 0, scale = 0.4}
			}
		}
		,
		["turbo"] = {
	...
	["armor"] = {
		...
		buttons = {
			...
			{name = "Armor Upgrade 20%",modtype = 16, mod = false, costs = 10000, description = "", centre = 0, font = 0, scale = 0.4},
	...
	["brakes"] = {
		...
		buttons = {
			...
			{name = "Street Brakes",modtype = 12, mod = false, costs = 2000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Sport Brakes",modtype = 12, mod = 1, costs = 4000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "Race Brakes",modtype = 12, mod = 2, costs = 6000, description = "", centre = 0, font = 0, scale = 0.4}
	...
	["engine"] = {
		...
		buttons = {
			...
			{name = "EMS Upgrade, Level 3",modtype = 11, mod = 1, costs = 4000, description = "", centre = 0, font = 0, scale = 0.4},
			{name = "EMS Upgrade, Level 4",modtype = 11, mod = 2, costs = 6000, description = "", centre = 0, font = 0, scale = 0.4}
		}
	},
	["horn"] = {
			title = "horns",
