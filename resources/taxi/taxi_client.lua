...
local TEXT = {
    ...
    BlipGarage = "Taxi",
    MissionCancel = 'Votre course a été annulé',
    MissionClientAccept = 'Un taxi a prit votre appel',
    MissionClientCancel = 'Votre taxi vous a abandonné',
    ...
    CALL_CANCEL = 'Le taxi vient d\'abandonner votre appel',
    ...
    MISSION_EN_COURS = 'Il y a deja un collègue sur le coup'
