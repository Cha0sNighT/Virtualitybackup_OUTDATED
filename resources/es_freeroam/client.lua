...
AddEventHandler('es_freeroam:spawnPlayer', function(x, y, z)
  ...
  AddEventHandler("playerSpawned", function(spawn)
    ...
    while true do
      ...
      AddTextComponentString("Bienvenue sur le serveur ~g~Virtuality !.\n ~y~Pour plus d'informations tapez /help");
      SetNotificationMessage("CHAR_ALL_PLAYERS_CONF", "CHAR_ALL_PLAYERS_CONF", true, 1, "Discord: ", "https://discord.gg/z4Gub7h");
